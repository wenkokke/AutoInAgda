...
instance, we could create an IDE feature which takes the proofs
generated by the |auto| function and replaces the call to |auto| in
the source file. An advantage of this would be that reloading the file
would no longer need to recompute the proof terms.
\pepijn{I changed this sentence, can you check if I changed what
