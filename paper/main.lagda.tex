...
\pepijn{
  Hm. Omdat het handiger was. Het liet je een aantal dingen wat
...
\pepijn{
  Vergeten dit te bespreken, maar het probleem is dat wanneer je
  decidable equality wilt testen op names (en je niet deze constructie
  gebruikt) je afzonderlijk moest testen op de gelijkheid van de
  ariteiten.
}
